...
async function main() {
    try {
        ...
        const orgInfo = ccp.organizations['072b69bebcc2e1980db04ae061a934d2e893f2c2'];
...
//            mspId: orgInfo.mspid,
        ...
        const createTxResult = await contract.createTransaction("createTx")
            .submit("TX003", "David Cruz", "Acct1", "Bank1", "Addr1", "Elena Cruz", "Acct2", "Bank2", "Addr2", "USD", "200.01", "asdsadsadas", "213112dsdas", "123ddasdasd");
        console.log(new String(createTxResult));

        // Evaluate transactions that query state from the ledger.
        const queryTxResult = await contract.evaluateTransaction("queryTx", "TX003");
